...
const mockPhotos: PhotoLog[] = [
  { id: 'PH-001', workOrder: 'OT-2025-041', equipment: 'Pompe centrifuge Grundfos', technician: 'K. Bensaid', date: '2025-06-12', beforeImage: 'https://images.unsplash.com/photo-1565043589221-1a6fd9ae45c7?w=600&h=400&fit=crop', afterImage: 'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=600&h=400&fit=crop', notes: 'Remplacement joint mécanique', status: 'completed' },
  { id: 'PH-002', workOrder: 'OT-2025-038', equipment: 'Compresseur Atlas Copco', technician: 'A. Mokhtar', date: '2025-06-10', beforeImage: 'https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=600&h=400&fit=crop', afterImage: 'https://images.unsplash.com/photo-1581094651181-35942459ef62?w=600&h=400&fit=crop', notes: 'Nettoyage filtre air + changement huile', status: 'completed' },
  { id: 'PH-003', workOrder: 'OT-2025-035', equipment: 'Convoyeur CV-05', technician: 'S. Hamdi', date: '2025-06-08', beforeImage: 'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?w=600&h=400&fit=crop', afterImage: '', notes: 'Remplacement courroie en cours', status: 'pending' },
  { id: 'PH-004', workOrder: 'OT-2025-029', equipment: 'Robot soudeur KUKA', technician: 'Y. Mourad', date: '2025-06-05', beforeImage: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&h=400&fit=crop', afterImage: 'https://images.unsplash.com/photo-1581092335397-9583eb92d232?w=600&h=400&fit=crop', notes: 'Calibrage axes + lubrification', status: 'completed' },
  { id: 'PH-005', workOrder: 'OT-2025-024', equipment: 'Tour CNC Mazak', technician: 'M. Bennani', date: '2025-06-02', beforeImage: 'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=600&h=400&fit=crop', afterImage: 'https://images.unsplash.com/photo-1565008576549-57569a49371d?w=600&h=400&fit=crop', notes: 'Remplacement broche', status: 'completed' },
];
