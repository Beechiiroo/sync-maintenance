...
const technicians: Technician[] = [
  ...
  { id: 3, name: 'Amine Tazi', role: 'Technicien', speciality: 'Hydraulique', tasks: 10, completed: 9, rating: 4.7, avatar: 'AT', status: 'disponible', phone: '+212 6 34 56 78', experience: '6 ans', certifications: ['ISO 9001'], photoUrl: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face' },
  ...
  { id: 5, name: 'Rachid Korbi', role: 'Technicien Junior', speciality: 'Mécanique', tasks: 6, completed: 5, rating: 4.2, avatar: 'RK', status: 'disponible', phone: '+212 6 56 78 90', experience: '2 ans', certifications: [], photoUrl: 'https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?w=200&h=200&fit=crop&crop=face' },
